Vagrant.configure("2") do |config|
  ...
  config.vm.define "jenkins" do |jenkins|
    ...
    jenkins.vm.box_url = "http://vm.onmylemon.co.uk/vagrant/boxes/base64.box"
  ...
  config.vm.define "nginx" do |nginx|
    nginx.vm.box = "base64"
    nginx.vm.box_url = "http://vm.onmylemon.co.uk/vagrant/boxes/base64.box"
  ...
  config.vm.define "mysql" do |mysql|
    mysql.vm.box = "base64"
    mysql.vm.box_url = "http://vm.onmylemon.co.uk/vagrant/boxes/base64.box"
